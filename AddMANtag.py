...
def AddMANtag(model, input_file, output_file):
...
if __name__ == "__main__":
	...
	if len(sys.argv)>3:
	        ...
	        print "model_path = ANN/submitted_models_PU_pt_both.h5"
	        input_file = "flatTuple_MANtest.root"
	        output_file = "AddMANtag2_test.root"
	        model_path = "ANN/submitted_models_PU_pt_both.h5"
	
	
	model = kr.models.load_model(model_path)
	np.seterr(divide='ignore', invalid='ignore')

	AddMANtag(model, input_file, output_file)
